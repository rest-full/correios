...
class Freight implements FreightInterface
{
    ...
    {
        $this->payload['sCepDestino'] = preg_replace(
            '/[^0-9]/', null, $zipCode
        );
        return $this;
    }
    ...
    public function item(
        float $width, float $height, float $length, float $weight,
        int $quantity = 1
    ): Freight
    {
        $this->items[] = compact(
    ...
    public function calculate(): array
    {
        ...
        $services = array_map([$this, 'fetchCorreiosService'],
            $servicesResponses);
    ...
    protected function friendlyServiceName(string $code)
    {
        $services = [
            'PAC' => 'PAC', 'SEDEX' => 'Sedex',
            'SEDEX_A_COBRAR' => 'Sedex a Cobrar', 'SEDEX_10' => 'Sedex 10',
